    ...
    <div class=" bread-crumb-inn">
        <div class="ttl-are">
            ...
            <a href="javascript:void(0);" class="label--toggle">
                ...
                <span class="icon icon-arrow" style="background-image: none;"><svg width="8" height="5"
                        viewBox="0 0 8 5" xmlns="http://www.w3.org/2000/svg">
...
<section class="projects-listing custom-taxonomy filter-disable">
   ...
   <div class="load-more-container load-more-container--hub">
        <a href="javascript:void(0)" class="cta__text load_more1 second" slug ="<?= $slug; ?>"value ="<?= $paged+1;?>" total="<?= ceil($numberOfPosts/2); ?> "  taxonomy="<?= $taxonomy; ?>">Load More <span class="cta__icon icon icon-plus" style="background-image: none;"><svg id="Layer_1"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40.6 40.6">
                <style>
                    .st0 {
                        fill: none;
                        stroke: #343434;
