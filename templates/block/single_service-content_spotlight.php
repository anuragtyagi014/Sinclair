...
<?php }else{ ?>
<h6 style="color:<?= $sectextcolor; ?>"><?= $postrow->post_type; ?></h6>
<?php } if($headingdata ==1){ ?> 
<h1 style="color:<?= $sectextcolor; ?>"><?= (!empty($spotlightcontent['heading_override_'])) ? $spotlightcontent['heading_override_'] : 'Add Your Post Heading'; ?></h1>
<?php }else{ ?>
